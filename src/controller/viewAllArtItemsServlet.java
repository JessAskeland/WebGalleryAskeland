...
/**
 * Servlet implementation class viewAllArtItemsServlet
 */
@WebServlet("/viewAllArtItemsServlet")
public class viewAllArtItemsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewAllArtItemsServlet() {
        super();
